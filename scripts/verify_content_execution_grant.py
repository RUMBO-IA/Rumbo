...
def verify(root: pathlib.Path = ROOT) -> list[str]:
    ...
    expected_policy = {
        ...
        "authority_anchor_commit": "c277753a8ba8e3a770daf928d88603355fe2413f",
        "grant_issuance_commit": "b9b29f40204ee24ee873df253b7bb505080813cd",
        "grant_issuance_state_sha256": "29d807872b12e2a2003ec1c1d54caad2b83276d3daf7c11f675a4b6d6b1eee55",
